...
def dubai_flights(origin):
	...
	l1=Label(f2,text="Spicejet+Burj Khalifa",font=("arial",30,"bold"),fg="black",bg="white")
	l1.place(x=0,y=40)
	...
	t1.place(x=0,y=160)
	b1=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command=lambda:main(root,"Burj Khalifa"))
	b1.place(x=9,y=240)
	...
	l3=Label(f2,text="Emirates+Atlantis",font=("arial",30,"bold"),fg="black",bg="white")
	l3.place(x=0,y=320)
	...
	t1.place(x=0,y=440)
	b1=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command=lambda:main(root,"Atlantis"))
	b1.place(x=9,y=520)
	...
	l5=Label(f2,text="Indigo+Duhram Mariott Hotel",font=("arial",30,"bold"),fg="black",bg="white")
	l5.place(x=0,y=600)
	...
	t2.place(x=0,y=720)
	b2=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command=lambda:main(root,"Duhram Mariott Hotel"))
	b2.place(x=9,y=800)
	...
	l7=Label(f2,text="Jet Airways+Fortune Hotel",font=("arial",30,"bold"),fg="black",bg="white")
	l7.place(x=0,y=880)
	...
	t3.place(x=0,y=1000)
	b3=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command=lambda:main(root,"Fortune Hotel"))
	b3.place(x=9,y=1080)
