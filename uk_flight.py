...
def uk_flight(origin):
	...
	l1=Label(f2,text="Spicejet+The Montauge on garden",font=("arial",30,"bold"),fg="black",bg="white")
	l1.place(x=0,y=40)
	...
	t1.place(x=0,y=160)
	b1=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"The Montauge on garden"))
	b1.place(x=9,y=240)
	...
	l3=Label(f2,text="Emirates+Draycott Hotel",font=("arial",30,"bold"),fg="black",bg="white")
	l3.place(x=0,y=320)
	...
	t1.place(x=0,y=440)
	b1=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"Draycott Hotel"))
	b1.place(x=9,y=520)
	...
	l5=Label(f2,text="Indigo+The Crown Lodge",font=("arial",30,"bold"),fg="black",bg="white")
	l5.place(x=0,y=600)
	...
	t2.place(x=0,y=720)
	b2=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"The Crown Lodge"))
	b2.place(x=9,y=800)
	...
	l7=Label(f2,text="Jet Airways+The George",font=("arial",30,"bold"),fg="black",bg="white")
	l7.place(x=0,y=880)
	...
	t3.place(x=0,y=1000)
	b3=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"The George"))
	b3.place(x=9,y=1080)
