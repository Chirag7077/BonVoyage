...
def maldives_flight(origin):
	...
	lb=Label(top,text="MALDIVES",font=("lucida calligraphy",40,"bold"),fg="#4EB1BA",bg="white")
	lb.place(x=470,y=0)
	...
	l1=Label(f2,text="Emirates+The Grand Royale",font=("arial",30,"bold"),fg="black",bg="white")
	l1.place(x=0,y=40)
	...
	t1.place(x=0,y=160)
	b1=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"The Grand Royale"))
	b1.place(x=9,y=240)
	...
	l3=Label(f2,text="Spicejet+Paradise Resort",font=("arial",30,"bold"),fg="black",bg="white")
	l3.place(x=0,y=320)
	...
	t1.place(x=0,y=440)
	b1=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"Paradise Resort"))
	b1.place(x=9,y=520)
	...
	l5=Label(f2,text="Jet Airways+The Baros Maldives",font=("arial",30,"bold"),fg="black",bg="white")
	l5.place(x=0,y=600)
	l5=Label(f2,text="Before Discount :",font=("arial",20,"bold"),fg="blue",bg="white")
	l5.place(x=0,y=650)
	l5=Label(f2,text="Rs.45000",font=("arial",20,"overstrike"),fg="red",bg="white")
	l5.place(x=235,y=650)
	l5=Label(f2,text="After Discount : ",font=("arial",20,"bold"),fg="blue",bg="white")
	l5.place(x=0,y=680)
	l5=Label(f2,text="Rs.30000",font=("arial",20,"bold"),fg="green",bg="white")
	...
	t2.place(x=0,y=720)
	b2=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"The Baros Maldives"))
	b2.place(x=9,y=800)
	...
	l7=Label(f2,text="Indigo+The Grand Royale",font=("arial",30,"bold"),fg="black",bg="white")
	l7.place(x=0,y=880)
	...
	t3.place(x=0,y=1000)
	b3=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"The Grand Royale"))
	b3.place(x=9,y=1080)
