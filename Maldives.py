...
import HomePage
import maldives_flight
from booking1 import main

def maldivespage(home_root):
        home_root.destroy()
        root=Tk()
        ...
        b.config(image=img,width="60",height="70",bg="white",bd=0)
        ...
        t1.place(x=0,y=160)
        b1=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"The Mirihi Island"))
        b1.place(x=9,y=240)
        ...
        t1.place(x=0,y=440)
        b1=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"Komandoo Maldives Island"))
        b1.place(x=9,y=520)
        ...
        t4.place(x=0,y=1280)
        b4=Button(f2,text="BOOK",padx=20,pady=10,bd=5,bg="blue",fg="white",command = lambda : main(root,"Paradise Island Resort"))
        b4.place(x=9,y=1360)
        #-----------------------NEXT-----------------------------------------
        b5=Button(f2,text="NEXT",padx=20,pady=10,bd=5,bg="red",fg="white",command=lambda:maldives_flight.maldives_flight(root))
